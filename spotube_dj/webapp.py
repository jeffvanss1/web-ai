...
bottom:0;width:360px;max-width:92vw;z-index:30;box-shadow:-18px 0 60px rgba(0,0,0,.6)}}
...
.row .ar{display:none}.right .vol input{width:60px} .app.wide .detail{width:min(360px,100%)}}
